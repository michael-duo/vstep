...
### Ngôn ngữ
- [ ] Dùng ít nhất **3 [từ nối](/foundation/universal-phrases/#cụm-từ-kết-nối)** (*because, however, in addition, therefore...*)
...
### Bố cục ([xem template](/writing/task-2/3-khung/))
- [ ] Có **Introduction** giới thiệu chủ đề
- [ ] Có ít nhất **2 đoạn Body** (mỗi đoạn **2 ý chính**)
...
### Ngôn ngữ
- [ ] Dùng ít nhất **5 [từ nối](/foundation/universal-phrases/#cụm-từ-kết-nối)** đa dạng
